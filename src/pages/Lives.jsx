    ...
    <div className="container mx-auto px-4 pt-8 pb-24 animate-fade-in">
      ...
      <div className="flex justify-evenly items-center  gap-2 pt-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-purple-300 
            border border-purple-500/30 rounded-lg transition-all duration-300 
            hover:bg-purple-500/10 hover:scale-105 active:scale-95 justify-center w-auto md:w-1/5"
        >
          ...
          <span className="inline">{t("common.share")}</span>
        </button>
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-blue-400 
            border border-blue-400/30 rounded-lg transition-all duration-300 
            hover:bg-blue-400/10 hover:scale-105 active:scale-95 justify-center w-auto md:w-1/5"
        >
          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
          </svg>
          <span className="hidden md:inline ">{t("common.shareTwitter")}</span>
        </button>
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-sky-500 
            border border-sky-500/30 rounded-lg transition-all duration-300 
            hover:bg-sky-500/10 hover:scale-105 active:scale-95 justify-center w-auto md:w-1/5"
        >
          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
            <path d="M20.5 2h-17A1.5 1.5 0 002 3.5v17A1.5 1.5 0 003.5 22h17a1.5 1.5 0 001.5-1.5v-17A1.5 1.5 0 0020.5 2zM8 19H5v-9h3zM6.5 8.25A1.75 1.75 0 118.3 6.5a1.78 1.78 0 01-1.8 1.75zM19 19h-3v-4.74c0-1.42-.6-1.93-1.38-1.93A1.74 1.74 0 0013 14.19a.66.66 0 000 .14V19h-3v-9h2.9v1.3a3.11 3.11 0 012.7-1.4c1.55 0 3.36.86 3.36 3.66z"/>
          </svg>
          <span className="hidden md:inline ">{t("common.shareLinkedin")}</span>
        </button>
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-green-500 
            border border-green-500/30 rounded-lg transition-all duration-300 
            hover:bg-green-500/10 hover:scale-105 active:scale-95 justify-center w-auto md:w-1/5"
        >
          <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
          ...
          <span className="hidden md:inline ">{t("common.shareWhatsapp")}</span>
        </button>
      </div>
