...
const Lives = () => {
  ...
  // Determinar la categoría según la ruta
  const path = currentPath.split("/")[1];
  // Mapear rutas a categorías del hook auto
  const categoryMap = {
    lives: "lives",
    eventos: "eventos",
    cursos: "cursos",
  ...
  const category = categoryMap[path] || "lives";
  const { videos, loading, error } = useAutoVideos(category);
